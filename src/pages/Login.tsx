...
const Login = () => {
  ...
  useEffect(() => {
    if (isAuthenticated && role) {
      navigate(role === "seller" ? "/pos" : "/dashboard", { replace: true });
    }
      ...
      <div className="w-full max-w-sm animate-fade-in">
        <div className="bg-card rounded-2xl shadow-xl p-8 space-y-6">
          ...
          <div className="text-center space-y-3">
            <div className="mx-auto w-16 h-16 rounded-2xl flex items-center justify-center overflow-hidden bg-primary/10">
              {settings.logoUrl ? (
            ...
            <h1 className="text-2xl font-bold text-foreground">{settings.storeName || "إدارة المتجر"}</h1>
